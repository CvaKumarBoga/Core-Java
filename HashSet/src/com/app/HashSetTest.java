...
/*HashSet is implementation class of Set interface and extends AbstractSet.It does not allow 
duplicates and allow null values HashSet is not synchronized.*/
public class HashSetTest {
	public static void main(String[] args) {
		 ...
		 * or not.If it is returns true object not added to set or else object add. 
		 */
